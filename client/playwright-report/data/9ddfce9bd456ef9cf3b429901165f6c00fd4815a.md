...
- Name: admin-reports.spec.ts >> Admin — Gestión de Reportes - E2E >> panel admin autenticado >> tab Usuarios carga la lista de usuarios
- Location: tests\e2e\admin-reports.spec.ts:161:5
