...
- Name: admin-reports.spec.ts >> Admin — Gestión de Reportes - E2E >> panel admin autenticado >> muestra el dropdown de filtro de estado en el header
- Location: tests\e2e\admin-reports.spec.ts:62:5
...
Call log:
  - Expect "toHaveURL" with timeout 10000ms
    4 × unexpected value "http://localhost:4278/login"
    9 × unexpected value "http://localhost:4278/trips"
