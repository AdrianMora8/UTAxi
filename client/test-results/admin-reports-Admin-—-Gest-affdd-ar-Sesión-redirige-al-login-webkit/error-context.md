...
- Name: admin-reports.spec.ts >> Admin — Gestión de Reportes - E2E >> panel admin autenticado >> Cerrar Sesión redirige al login
- Location: tests\e2e\admin-reports.spec.ts:189:5
