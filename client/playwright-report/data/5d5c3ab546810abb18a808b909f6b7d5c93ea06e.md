...
- Name: admin-reports.spec.ts >> Admin — Gestión de Reportes - E2E >> panel admin autenticado >> muestra la lista de reportes o estado vacío
- Location: tests\e2e\admin-reports.spec.ts:73:5
