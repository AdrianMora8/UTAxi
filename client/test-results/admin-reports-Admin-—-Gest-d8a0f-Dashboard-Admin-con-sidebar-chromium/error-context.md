...
- Name: admin-reports.spec.ts >> Admin — Gestión de Reportes - E2E >> panel admin autenticado >> muestra el Dashboard Admin con sidebar
- Location: tests\e2e\admin-reports.spec.ts:37:5
...
Call log:
  - Expect "toHaveURL" with timeout 10000ms
    5 × unexpected value "http://localhost:4278/login"
    8 × unexpected value "http://localhost:4278/trips"
