...
- Name: admin-reports.spec.ts >> Admin — Gestión de Reportes - E2E >> panel admin autenticado >> filtrar por Abiertos recarga la lista de reportes
- Location: tests\e2e\admin-reports.spec.ts:80:5
