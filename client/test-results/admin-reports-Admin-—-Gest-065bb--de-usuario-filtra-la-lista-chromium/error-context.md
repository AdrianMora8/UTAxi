...
- Name: admin-reports.spec.ts >> Admin — Gestión de Reportes - E2E >> panel admin autenticado >> búsqueda de usuario filtra la lista
- Location: tests\e2e\admin-reports.spec.ts:166:5
