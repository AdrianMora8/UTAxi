...
- Name: admin-reports.spec.ts >> Admin — Gestión de Reportes - E2E >> panel admin autenticado >> ReviewModal se cierra al hacer clic en el backdrop
- Location: tests\e2e\admin-reports.spec.ts:123:5
