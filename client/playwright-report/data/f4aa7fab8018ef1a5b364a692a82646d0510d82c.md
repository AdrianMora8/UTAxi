...
- Name: admin-reports.spec.ts >> Admin — Gestión de Reportes - E2E >> panel admin autenticado >> muestra los 4 tabs de navegación en el sidebar
- Location: tests\e2e\admin-reports.spec.ts:42:5
