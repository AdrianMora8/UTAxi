...
- Name: admin-reports.spec.ts >> Admin — Gestión de Reportes - E2E >> panel admin autenticado >> tab Reportes está activo por defecto y muestra "Gestión de Reportes"
- Location: tests\e2e\admin-reports.spec.ts:58:5
...
Call log:
  - Expect "toHaveURL" with timeout 10000ms
    ...
    11 × unexpected value "http://localhost:4278/trips"
    ...
    - generic [ref=e5]:
      ...
      - generic [ref=e7]:
        - link "Buscar Viaje" [ref=e8]:
          - /url: /trips
        - link "Mis Solicitudes" [ref=e9]:
          - /url: /requests
        - link "U-Wallet" [ref=e10]:
          - /url: /wallet
        - link "Admin" [ref=e11]:
          - /url: /admin
        - generic [ref=e12]:
          - generic [ref=e13]: Pasajero
          - link "account_circle" [ref=e14]:
            - /url: /profile
