...
- Name: admin-reports.spec.ts >> Admin — Gestión de Reportes - E2E >> panel admin autenticado >> filtrar por Resueltos recarga la lista
- Location: tests\e2e\admin-reports.spec.ts:88:5
